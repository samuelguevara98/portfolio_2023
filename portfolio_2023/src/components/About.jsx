...
const About = () => {
  return (
    <div
      name='about'
      className='w-full h-screen bg-amber-600 text-white'>
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
        ...
        <p className='text-xl mt-20'>
          Hi there! I'm Samuel, a coding enthusiast and entrepreneur from North
        ...
        <p className='text-xl'>
          ...
          where I worked on diverse projects and collaborated with fellow
        ...
        <p className='text-xl'>
          ...
          decisions. As a business owner, I've overcome obstacles related to
